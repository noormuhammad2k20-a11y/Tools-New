...
class ImageHandler extends Model {
    ...
    private function getUploadedImage($fileKey = 'file') {
        ...
        // Block double extensions and PHP-like files
        if (preg_match('/\.(php|phtml|php3|php4|php5|phps)/i', $name)) {
            return false;
        }
        ...
        return ['path' => $tmp, 'type' => $type, 'name' => $safeName, 'size' => $_FILES[$fileKey]['size']];
    }
