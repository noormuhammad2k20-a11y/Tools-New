                    ...
                    <div class="bg-light p-4 rounded-4 border">
                        <div class="row g-4 align-items-center">
                            <div class="col-md-5">
                                ...
                                <input type="number" id="input-val" class="form-control form-control-lg" placeholder="1" step="any">
                            </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const convert = () => {
        ...
        // Calculation: oz * 28.3495
        output.value = (val * 28.3495231).toFixed(5).replace(/\.?0+$/, '');
    };
