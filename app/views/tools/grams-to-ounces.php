                ...
                <div class="col-lg-8">
                    <div class="bg-light p-4 rounded-4 border">
                        <div class="row g-4 align-items-center">
                            <div class="col-md-5">
                                <label class="form-label fw-bold small">Grams (g)</label>
                                <input type="number" id="input-val" class="form-control form-control-lg" placeholder="100" step="any">
                            </div>
                            ...
                            <div class="col-md-5">
                                <label class="form-label fw-bold small">Ounces (oz)</label>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const convert = () => {
        ...
        // Calculation: g * 0.035274
        output.value = (val * 0.03527396).toFixed(5).replace(/\.?0+$/, '');
    };
