                ...
                <div class="col-lg-8">
                    <div class="bg-light p-4 rounded-4 border">
                        <div class="row g-4 align-items-center">
                            <div class="col-md-5">
                                <label class="form-label fw-bold small">Pounds (lbs)</label>
                                <input type="number" id="input-val" class="form-control form-control-lg" placeholder="10" step="any">
                            </div>
                            ...
                            <div class="col-md-5">
                                <label class="form-label fw-bold small">Kilograms (kg)</label>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const convert = () => {
        ...
        // Calculation: lbs * 0.453592
        output.value = (val * 0.45359237).toFixed(5).replace(/\.?0+$/, '');
    };
