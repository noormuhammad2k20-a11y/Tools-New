                ...
                <div class="col-lg-8">
                    <div class="bg-light p-4 rounded-4 border">
                        <div class="row g-4 align-items-center">
                            <div class="col-md-5">
                                <label class="form-label fw-bold small">Fahrenheit (°F)</label>
                                <input type="number" id="input-val" class="form-control form-control-lg" placeholder="32" step="any">
                            </div>
                            ...
                            <div class="col-md-5">
                                <label class="form-label fw-bold small">Celsius (°C)</label>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const convert = () => {
        ...
        // Formula: (°F - 32) * 5/9
        output.value = ((val - 32) * 5/9).toFixed(2).replace(/\.?0+$/, '');
    };
