                ...
                <div class="col-lg-8">
                    <div class="bg-light p-4 rounded-4 border">
                        <div class="row g-4 align-items-center">
                            <div class="col-md-5">
                                <label class="form-label fw-bold small">Meters (m)</label>
                            ...
                            <div class="col-md-5">
                                <label class="form-label fw-bold small">Feet (ft)</label>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const convert = () => {
        ...
        // Calculation: m * 3.28084
        output.value = (val * 3.2808399).toFixed(5).replace(/\.?0+$/, '');
    };
