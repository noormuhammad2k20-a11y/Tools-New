                    ...
                    <div class="bg-light p-4 rounded-4 border">
                        <div class="row g-4 align-items-center">
                            <div class="col-md-5">
                                ...
                                <input type="number" id="input-val" class="form-control form-control-lg" placeholder="7" step="any">
                            </div>
                            ...
                            <div class="col-md-5">
                                <label class="form-label fw-bold small">Weeks (wk)</label>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const convert = () => {
        ...
        // Formula: days / 7
        output.value = (val / 7).toFixed(6).replace(/\.?0+$/, '');
    };
