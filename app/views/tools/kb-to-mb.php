                ...
                <div class="col-lg-8">
                    <div class="bg-light p-4 rounded-4 border">
                        <div class="row g-4 align-items-center">
                            <div class="col-md-5">
                                <label class="form-label fw-bold small">Kilobytes (KB)</label>
                                <input type="number" id="input-val" class="form-control form-control-lg" placeholder="1024" step="any">
                            </div>
                            ...
                            <div class="col-md-5">
                                <label class="form-label fw-bold small">Megabytes (MB)</label>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const convert = () => {
        ...
        // Formula: KB / 1024
        output.value = (val / 1024).toFixed(6).replace(/\.?0+$/, '');
    };
