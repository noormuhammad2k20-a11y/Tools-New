                ...
                <div class="col-lg-8">
                    <div class="bg-light p-4 rounded-4 border">
                        <div class="row g-4 align-items-center">
                            <div class="col-md-5">
                                <label class="form-label fw-bold small">Kilometers (km)</label>
                            ...
                            <div class="col-md-5">
                                <label class="form-label fw-bold small">Miles (mi)</label>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const convert = () => {
        ...
        // Calculation: km * 0.621371
        output.value = (val * 0.62137119).toFixed(5).replace(/\.?0+$/, '');
    };
