                ...
                <div class="col-lg-8">
                    <div class="bg-light p-4 rounded-4 border">
                        <div class="row g-4 align-items-center">
                            <div class="col-md-5">
                                <label class="form-label fw-bold small">Hours (hr)</label>
                                <input type="number" id="input-val" class="form-control form-control-lg" placeholder="24" step="any">
                            </div>
                            ...
                            <div class="col-md-5">
                                <label class="form-label fw-bold small">Days (d)</label>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const convert = () => {
        ...
        // Formula: hr / 24
        output.value = (val / 24).toFixed(6).replace(/\.?0+$/, '');
    };
