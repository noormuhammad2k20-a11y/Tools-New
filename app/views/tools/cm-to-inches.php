                ...
                <div class="col-lg-8">
                    <div class="bg-light p-4 rounded-4 border">
                        <div class="row g-4 align-items-center">
                            <div class="col-md-5">
                                <label class="form-label fw-bold small">Centimeters (cm)</label>
                                <input type="number" id="input-val" class="form-control form-control-lg" placeholder="2.54" step="any">
                            </div>
                            ...
                            <div class="col-md-5">
                                <label class="form-label fw-bold small">Inches (in)</label>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const convert = () => {
        ...
        // Calculation: cm / 2.54
        output.value = (val / 2.54).toFixed(5).replace(/\.?0+$/, '');
    };
